...
class format_buttons_renderer extends format_topics_renderer
{
     ...
     * @return string
     */
    protected function get_button_section($course, $sectionvisible, $position = null)
    {
        global $PAGE;
        $html = '';
        $css = '';
        ...
        // PRT
        if($position == 'top'){
            $html = html_writer::tag('div', $html, ['id' => 'buttonsectiontop']);
        }
        // fin PRT
    ...
    public function print_multiple_section_page($course, $sections, $mods, $modnames, $modnamesused)
    {
        ...
        echo $this->get_button_section($course, $sectionvisible, 'top');
        foreach ($htmlsection as $current) {
            echo $current;
        }

        // ajout PRT pour avoir une seconde barre de boutons
